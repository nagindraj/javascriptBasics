...
function createAttendanceData(membersData){
   ...
   createLeastEngagedTable(membersData);
   createMostEngagedTable(membersData);
}
...
function createLeastEngagedTable(membersData) {
   var mainTr = ''
...
function createMostEngagedTable(membersData) {
   var mainTr = ''
   var len = membersData.length;
   for(var i=0;i<len;i++) {
